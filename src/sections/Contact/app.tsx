...
const Contact = () => {
  const socialLinks = [
    {
      name: 'LinkedIn',
      url: 'https://www.linkedin.com/in/kruthik-s-9381b225b/',
      icon: (
    ...
    // {
    //   name: 'Gmail',
    //   url: 'mailto:gokruthik2003@gmail.com',
    //   icon: (
    //     <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:gokruthik2003@gmail.com" className="text-stone-400 hover:text-orange-400 transition-colors duration-200" style={{ fontFamily: 'Inter, system-ui, -apple-system, sans-serif' }}>
                      gokruthik2003@gmail.com
                    </a>
                  </div>
                </div>
